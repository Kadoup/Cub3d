...
/*   Updated: 2025/10/24 17:01:42 by emalmber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	move_left(t_game *game)
{
	...
	if (game->map[(int)(new_y + COLLISION_BUFFER)][(int)(new_x +
		COLLISION_BUFFER)] == '1' || game->map[(int)(new_y +
		COLLISION_BUFFER)][(int)(new_x - COLLISION_BUFFER)] == '1' ||
		game->map[(int)(new_y - COLLISION_BUFFER)][(int)(new_x +
		COLLISION_BUFFER)] == '1' || game->map[(int)(new_y -
		COLLISION_BUFFER)][(int)(new_x - COLLISION_BUFFER)] == '1')
		return (1);
	game->player.x = new_x;
